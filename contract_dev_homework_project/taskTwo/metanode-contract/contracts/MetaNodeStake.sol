    ...
    AccessControlUpgradeable
{
    ...
    */
     ...
     */
    //用户质押ERC20代币，用户需先调用 approve(...) 给本合约授权
    ...
    function _deposit(uint256 _pid, uint256 _amount) internal {
        ...
        //更新质押池信息：更新accMetaNodePerST-每单位质押代币累计可得的 MetaNode 数量，
        //计算用户此前应得但未领取的奖励 → 加入 pendingMetaNode
        //更新用户 stAmount-质押的代币数量 和 finishedMetaNode-已经领取的 MetaNode 数量
        updatePool(_pid);
